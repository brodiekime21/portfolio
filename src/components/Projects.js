      ...
      <div className="projects-side-by-side">
        <div id="samplewav" classname="project">
          ...
          <p className="project-description">
            <em>SampleWav</em>&nbsp;allows users to upload, browse, and download
            music samples and functions as a social media site allowing
            profiles, followers, comments, and reposts.
          </p>
          <img
        ...
        <div id="best-fest" classname="project">
          ...
          <p className="project-description">
            <em>Best Fest</em>&nbsp;allows users to sign up, create a profile,
            then rate, review, and comment on music festival experiences.
          </p>
          <img
            className="project-pics"
        ...
        <div id="save-the-rave" classname="project">
          ...
          <p className="project-description">
            <em>Save The Rave</em> is a canvas game that challenges players to
            save a rave by stopping distractions from getting to the DJ. The
            game also features a soundtrack and a fun theme.
          </p>
          <img
            className="project-pics"
